...
(function (App) {
  ...
  __decorate([App.Autobind], ProjectItem.prototype, "dragStartHandler", null);
  __decorate([App.Autobind], ProjectItem.prototype, "dragEndHandler", null);
  class ProjectList extends Component {
    ...
    dropHandler(event) {
      ...
      App.projectStateManager.moveProject(
        projectId,
    ...
    configure() {
      ...
      App.projectStateManager.addListener((projects) => {
    ...
    renderContent() {
      ...
      this.templateChildElement.querySelector("h2").textContent =
        headingContent;
    }
    renderProjects() {
  ...
  __decorate([App.Autobind], ProjectList.prototype, "dragOverHandler", null);
  __decorate([App.Autobind], ProjectList.prototype, "dropHandler", null);
  __decorate([App.Autobind], ProjectList.prototype, "dragLeaveHandler", null);
  class Form extends Component {
    constructor() {
      super("project-input", "app", true, "user-input");
      this.titleInput = this.templateChildElement.querySelector("#title");
      this.descriptionInput =
        this.templateChildElement.querySelector("#description");
    ...
    submitHandler(event) {
      ...
      if (Array.isArray(userInput) && userInput.length === 3) {
        ...
        App.projectStateManager.addProject(title, description, people);
        this.clearInputs();
      }
    }
  }
  __decorate([App.Autobind], Form.prototype, "submitHandler", null);
  new Form();
...
(function (App) {
  ...
  App.projectStateManager = ProjectState.getInstance();
})(App || (App = {}));
var App;
(function (App) {
